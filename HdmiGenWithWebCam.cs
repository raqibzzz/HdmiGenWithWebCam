...
public class Script
{
    ...
    // ======================================================================
    string  strHdmiSourceComPort    = "COM7";               // Nexsys HDMI source com port
    ...
    public void Run(IScriptOptions oHostOptions)
    {
            ...
            && (m_oNetwork != null) )
        {
            ...
            // m_oThread = new Thread(RunMyStuff2);
            m_oThread.Start();
        }
        else
    ...
    private string CamSnapshot()
    {
        ...
        oProcess.StartInfo.Arguments = "/devnum " + camIndex.ToString();
